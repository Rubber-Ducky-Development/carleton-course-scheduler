...
export function FeedbackDialog() {
  ...
  const characterLimit = 3000; return (
    <>      <Button
      onClick={openModal}
      variant="secondary"
      className="flex items-center gap-1 px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm bg-gray-400 hover:bg-gray-500 text-white min-w-0"
      size="sm"
    >
      <svg
      ...
      <span className="text-xs sm:text-sm whitespace-nowrap">Submit Feedback</span>
    </Button>
